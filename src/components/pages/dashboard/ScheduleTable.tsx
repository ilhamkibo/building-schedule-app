  ...
  return (
    <div className="border rounded p-3 bg-sidebar dark:border-slate-800 shadow-sm flex flex-col gap-2 w-full hover:shadow-md transition-shadow">
      <div className="flex justify-between items-center border-b dark:border-slate-800 pb-1 mb-1">
        ...
        <span className="text-[10px] bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-slate-500 dark:text-slate-400 font-medium">
          Size Code
        </span>
      </div>
      <div className="grid grid-cols-2 gap-x-2 gap-y-1 mt-1">
        <div className="flex flex-col">
          ...
          <span className="text-sm font-bold text-emerald-600 dark:text-emerald-500 leading-tight">
            {machine.stock}{" "}
...
export function ScheduleTable({
  ...
  function renderRemark(remark?: string) {
    ...
    return (
      <Tooltip>
        ...
        >
          <p className="font-semibold mb-1 border-b border-red-200 pb-1">
            Remark
          </p>
  ...
  function getShiftClass(shift: number, base: string) {
    return currentShift === shift ? `${base} font-bold` : "";
  }
  ...
  const shifts = [
    {
      id: 1,
      color:
        "bg-blue-50/40 dark:bg-blue-950/10 text-blue-700 dark:text-blue-400",
      buildKey: "shift1",
    ...
    },
    {
      id: 2,
      color:
        "bg-orange-50/40 dark:bg-orange-950/10 text-orange-700 dark:text-orange-400",
      buildKey: "shift2",
    ...
    >
      <div className="px-5 py-3 font-bold bg-muted/30 dark:bg-muted/10 border-b dark:border-slate-800 flex justify-between items-center text-slate-700 dark:text-slate-200">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2.5 py-1 rounded-full border border-blue-200 dark:border-blue-800">
            {block.shift || "All Shifts"}
          </span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-[1fr_900px] min-w-[1750px]">
          <table className="w-full text-xs border-r dark:border-slate-800 border-collapse">
            <thead className="bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-sm sticky top-0 z-10 text-slate-600 dark:text-slate-400">
              <tr>
                <th
                  className="border dark:border-slate-800 p-2 font-bold"
                  rowSpan={2}
                >
                  RIM
                </th>
                <th
                  className="border dark:border-slate-800 p-2 font-bold text-slate-900 dark:text-slate-100 uppercase tracking-wider"
                  rowSpan={2}
                >
                  Code
                </th>
                <th
                  className="border dark:border-slate-800 p-1 font-medium"
                  rowSpan={2}
                >
                  Cure /shift
                </th>
                ...
                <th
                  className={`border dark:border-slate-800 border-l-2 border-l-blue-200 dark:border-l-blue-900 p-1.5 ${getCurrentShift(shiftTime) === 1 ? "bg-blue-50/50 dark:bg-blue-950/20 font-bold text-blue-700 dark:text-blue-400" : ""}`}
                  colSpan={4}
                >
                  SHIFT 1
                </th>
                <th
                  className={`border dark:border-slate-800 border-l-2 border-l-orange-200 dark:border-l-orange-900 p-1.5 ${getCurrentShift(shiftTime) === 2 ? "bg-orange-50/50 dark:bg-orange-950/20 font-bold text-orange-700 dark:text-orange-400" : ""}`}
                  colSpan={4}
                >
                  SHIFT 2
                </th>
                <th
                  className={`border dark:border-slate-800 border-l-2 border-l-emerald-200 dark:border-l-emerald-900 border-r-2 border-r-slate-200 dark:border-r-slate-800 p-1.5 ${getCurrentShift(shiftTime) === 3 ? "bg-emerald-50/50 dark:bg-emerald-950/20 font-bold text-emerald-700 dark:text-emerald-400" : ""}`}
                  colSpan={4}
                >
                  SHIFT 3
                </th>
              ...
              <tr className="bg-slate-50/30 dark:bg-slate-900/30 text-[10px] uppercase font-bold tracking-tight">
                <th
                  className={`border dark:border-slate-800 border-l-2 border-l-blue-200 dark:border-l-blue-900 p-1 ${getCurrentShift(shiftTime) === 1 ? "bg-blue-50/50 dark:bg-blue-950/20" : ""}`}
                >
                  Time
                </th>
                <th
                  className={`border dark:border-slate-800 p-1 ${getCurrentShift(shiftTime) === 1 ? "bg-blue-50/50 dark:bg-blue-950/20" : ""}`}
                >
                  Pri
                </th>
                <th
                ...
                <th
                  className={`border dark:border-slate-800 border-l-2 border-l-orange-200 dark:border-l-orange-900 p-1 ${getCurrentShift(shiftTime) === 2 ? "bg-orange-50/50 dark:bg-orange-950/20" : ""}`}
                >
                  Time
                </th>
                <th
                  className={`border dark:border-slate-800 p-1 ${getCurrentShift(shiftTime) === 2 ? "bg-orange-50/50 dark:bg-orange-950/20" : ""}`}
                >
                  Pri
                </th>
                <th
                ...
                <th
                  className={`border dark:border-slate-800 border-l-2 border-l-emerald-200 dark:border-l-emerald-900 p-1 ${getCurrentShift(shiftTime) === 3 ? "bg-emerald-50/50 dark:bg-emerald-950/20" : ""}`}
                >
                  Time
                </th>
                <th
                  className={`border dark:border-slate-800 p-1 ${getCurrentShift(shiftTime) === 3 ? "bg-emerald-50/50 dark:bg-emerald-950/20" : ""}`}
                >
                  Pri
                </th>
                <th
                  className={`border dark:border-slate-800 p-1 border-r-2 border-r-slate-200 dark:border-r-slate-800 ${getCurrentShift(shiftTime) === 3 ? "bg-emerald-50/50 dark:bg-emerald-950/20" : ""}`}
                >
                  Qty
                </th>
                <th
            ...
            <tbody>
              {block.rows.map((r, i) => (
                <tr key={i} className="text-center h-8 border-b">
                  ...
                  <td className="border p-1">{formatBO(r.balanceOut)}</td>
                  ...
                  {shifts.map((s) => (
                    <React.Fragment key={s.id}>
                      {/* TIME */}
                      <td
                        className={`border p-1 ${getShiftClass(s.id, s.color)}`}
                      >
  ...
  return (
    <div className="relative h-8 border-b dark:border-slate-800 overflow-hidden">
      ...
      {[...phases]
        .sort(
          (a, b) =>
            PHASE_CONFIG[a.type].priority - PHASE_CONFIG[b.type].priority,
        )
        .map((p: SchedulePhase, i: number) => {
              ...
              <TooltipContent className="p-2 text-xs flex flex-col gap-1 min-w-[150px]">
                <div className="flex items-center justify-between border-b pb-1 mb-1 gap-2">
                  ...
                  <span className="text-slate-500 font-mono">
                    {formatDecToTime(startNormal)} -{" "}
                    {formatDecToTime(endNormal)}
                  </span>
                </div>
