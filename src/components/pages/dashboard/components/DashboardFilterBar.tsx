    ...
    <div className="px-4 mb-4 rounded-md py-2 font-semibold bg-sidebar border-b dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        <Select value={selectedLineNo} onValueChange={onLineNoChange}>
          <SelectTrigger className="md:w-45 w-full h-8 font-semibold bg-background dark:border-slate-700">
        ...
        <Input
          ...
          className="md:w-40 w-full h-9 font-semibold bg-background dark:border-slate-700"
        />

        {isAdminOrEditor && onRefreshClick && onEditClick && (
          <Button variant="outline" onClick={onEditClick} className="h-9 gap-2">
            Edit Schedule
          </Button>
        )}
